...
[bee-js/src/utils/bytes.ts:12](https://github.com/ethersphere/bee-js/blob/0e69ca1/src/utils/bytes.ts#L12)
...
▸ **copyWithin**(`target`, `start`, `end?`): [`Bytes`](utils.bytes.bytes.md)<`Length`\>
...
[`Bytes`](utils.bytes.bytes.md)<`Length`\>
...
▸ **fill**(`value`, `start?`, `end?`): [`Bytes`](utils.bytes.bytes.md)<`Length`\>
...
▸ **sort**(`compareFn?`): [`Bytes`](utils.bytes.bytes.md)<`Length`\>
