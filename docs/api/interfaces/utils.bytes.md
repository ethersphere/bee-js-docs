...
[bee-js/src/utils/bytes.ts:12](https://github.com/ethersphere/bee-js/blob/5b112bf/src/utils/bytes.ts#L12)
...
▸ **copyWithin**(`target`, `start`, `end?`): [`Bytes`](utils.bytes.md)<`Length`\>
...
▸ **fill**(`value`, `start?`, `end?`): [`Bytes`](utils.bytes.md)<`Length`\>
...
▸ **sort**(`compareFn?`): [`Bytes`](utils.bytes.md)<`Length`\>
